This project is for the APS SDC 2024 and is created by team Bountenna. To be able to use this repository, the required libraries that are written in requirement.txt needs to be installed. 
